...
class InputFeatures(object):
    ...
    def __init__(self, title_input_ids, title_input_mask, tags_input_ids, tags_input_mask, desc_input_ids, desc_input_mask, segment_ids, video_id, date, cat_view_count, cat_view_count_id):
        ...
        self.cat_view_count_id = cat_view_count_id
        self.segment_ids = segment_ids
        self.cat_view_count = cat_view_count
        ...
        records.append(
            {  
                ...
                "segment_ids": features.segment_ids,
                 "cat_view_count_id": features.cat_view_count_id,
                "video_id": the_input.video_id,
                "date": the_input.date,
                "cat_view_count": the_input.cat_view_count,
            }
